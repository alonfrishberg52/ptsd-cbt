...
// NOTE: New React components for patient overview cards, session calendar/timeline, and export/share widget will be placed in static/dashboard/components/.
// The main dashboard view will be updated to use these widgets.
...
// Dynamically load the React dashboard widgets bundle if present
(function() {
  var script = document.createElement('script');
  script.src = '/static/dashboard/js/dashboard_widgets.bundle.js';
  script.async = true;
  script.onload = function() { console.log('React dashboard widgets loaded.'); };
